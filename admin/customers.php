...
if (isset($_POST["ExportType"])) {
    if (isset($_POST['from_date']) && isset($_POST['to_date'])) {
        ...
        $query = "SELECT * FROM customer where date_created between '" . $from_date . "' 
...
if (isset($_POST['save_customer'])) {
    ...
    $query = "INSERT INTO customer(profile, full_name, address, valid_id, email_address, username, password, status)
            VALUES ('$profile', '$full_name', '$address', '$valid_id', '$email', '$username', '$password', '$status')";
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4><i class="mdi mdi-account-multiple"></i> Customer List</h4>
                            <div class="col-md-12 float-right mb-4">
                                <div class="btn-group pull-right">
                                    <a href="javascript:void(0);" data-toggle="modal" data-target="#addDriverModal" class="btn fs-22 py-1 btn-success">Add Customer</a>
