<?php 
    ...
    $id = $_SESSION["id"];
    $restaurant_sql = "SELECT * FROM customer WHERE id = $id";
    $restaurant_result = mysqli_query($link, $restaurant_sql);
    $resturant = $restaurant_result->fetch_array(MYSQLI_ASSOC);
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4><i class="mdi mdi-face-profile"></i> Profile<strong></h4>
                        </div>
                    </div>
                </div>
                <!-- row -->
                                ...
                                <div class="profile-info">
									<div class="profile-photo">
                                        <?php if (isset($_SESSION["profile"])) { ?>
                                            <img src="../uploads/<?php echo $_SESSION['profile']; ?>" class="img-fluid rounded-circle"  alt=""/>
                                        <?php } else { ?>    
                                            <img src="../images/avatar/avatar.png"class="img-fluid rounded-circle"  alt=""/>
                                        <?php  } ?>
									</div>
									<div class="profile-details">
										<div class="profile-name px-3 pt-2">
											<h3 class="text-primary mb-0"><?php echo $resturant["full_name"]; ?></h3>
                                            <h6 class="text-muted mb-0"><?php echo $resturant["email_address"]; ?></h6>
											<p>Customer</p>
										</div>
