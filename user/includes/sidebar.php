    ...
    <div class="deznav-scroll">
        <ul class="metismenu">
            <?php if (isset($_SESSION["user"]) && $_SESSION["user"] === "customer") { ?>
                <li>
                    <a href="stores.php" class="ai-icon <?php if ($_SERVER['PHP_SELF'] == '/atadku/user/stores.php' || $_SERVER['PHP_SELF'] == '/atadku/user/product.php') { ?>active-nav <?php } ?>" aria-expanded="false">
            ...
            <?php if (isset($_SESSION["user"]) && $_SESSION["user"] === "owner") { ?>
                ...
                <li>
                    <a href="product_list.php" class="ai-icon <?php if ($_SERVER['PHP_SELF'] == '/atadku/user/product_list.php' || $_SERVER['PHP_SELF'] == '/atadku/user/order_info.php') { ?>active-nav <?php } ?>" aria-expanded="false">
                        <i class="mdi mdi-gift"></i>
                        <span class="nav-text">Product List</span>
                    </a>
                </li>
                <li>
                    <a href="orders.php" class="ai-icon <?php if ($_SERVER['PHP_SELF'] == '/atadku/user/orders.php' || $_SERVER['PHP_SELF'] == '/atadku/user/order_info.php') { ?>active-nav <?php } ?>" aria-expanded="false">
                        <i class="mdi mdi-cart-plus"></i>
                        <span class="nav-text">Order List</span>
                    </a>
                </li>
