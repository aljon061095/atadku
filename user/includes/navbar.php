                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                            ...
                            <?php  if(!empty($_SESSION["cart"])){
                                 foreach (array_slice($_SESSION["cart"], 0, 3) as $keys => $values) {
                                ?>
                                <a class="dropdown-item d-flex align-items-center" href="cart.php">
                                    ...
                                    <div>
                                        <span class="font-weight-bold"><?php echo $values["name"]; ?></span>
                                        <div class="small text-gray-500"><?php echo $values["quantity"] ?> - ₱ <?php echo number_format($values["price"], 2); ?></div>
                                    </div>
                                </a>
                            <?php } }?>
